...
- Once that we have pushed our repo, you need to create a tag for the code on github, we are calling it `v1.7`. 
...
```
lilypad run github.com/fedemagnani/LinearModelLily:v1.7 -i CID=QmaW9TL7ACBK4VFLxg7tbSnePjDnxd4R1upu4yb5xLBuy1 -i Y="Car Purchase Amount" -i IGNORE1="Customer Name" -i IGNORE2="Customer e-mail" -i IGNORE3="Country" --module-repo https://github.com/fedemagnani/LinearModelLily --module-hash 0a8d4734975db0fbf6c7aab4128ebb58960802bf --module-path ./lilypad_module.json.tmpl
```
### IMPORTANT: 
